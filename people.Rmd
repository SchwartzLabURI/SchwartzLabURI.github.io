...
<img src="eren.jpg" align="right" hspace="10" width="30%">
<br><br>
Eren Ada is a Ph.D. candidate in the Schwartz Lab. His dissertation focuses on utilizing large-scale genomic data in phylogenetic analyses. As the amount of DNA sequence data continues to increase, it has become more important to utilize this data in biological analyses, primarily in phylogenetics which is an essential tool to understand evolutionary history of traits, lineages, and the biodiversity in broader scale.

To effectively use large-scale genomic data, it is imperative to understand the characteristics of different types of sequence data (coding, noncoding, regulatory etc.) and the content of phylogenetic (dis)information they contain. He is primarily focusing on understanding how using the different type of informative sequence data manifest in phylogenetic outcomes such as contradicted relationships in phylogenies.

He also investigates how using these different genomic data affects phylogenetic estimates of diversification rates by means of molecular dating. He uses birds as model organisms in his studies, mainly because they are the one of the most phylogenetically studied group, secondly his love for birds.

When he is away from computer screen, he spends as much possible time in nature, most often bird-watching, swimming with the sunrise, hiking, or meditating. He wants to continue his career in bioinformatics, mainly through developing methods and tools for genomic analyses to improve our understanding of biological diversity in every level.
...
Jewel Voyer (URI BIO and Neuroscience '22) is using SISRS to examine relationships among the genus Ixodes. She hopes to look at the relationships between gene family evolution and song in birds.

Caleb Chapentier (SELU '22)

Alyssa Hartmann (URI BIO '21) is identifying cellulose synthase genes across mosses to determine how this gene family arose.

Keyline Moreno (URI '21)
